(function (WL) {
  ...
  function amazonQuickAdd () {
    ...
    var $cloneTarget = $('#add-to-wishlist-button-group');
    var $clone = $cloneTarget.clone().attr('id', buttonId)
      .addClass('amazon').removeClass('a-spacing-none');
    $clone.append($('<span/>').addClass('wunderlist-icon'));

    $clone.find('.a-button-text')
      .addClass('amazon')
      .attr('title', addString)
      .attr('data-action', '')
      .text(addString);

    var $targetContainer = $('#wishlistButtonStack');
  ...
  function youtubeQuickAdd () {
    ...
    var $target = $('.yt-uix-button-subscription-container:visible').first();
  ...
  function wikipediaQuickAdd () {
    ...
    var $target = $('.firstHeading span').first();
  ...
  function twitterIndexQuickAdd () {
    ...
    var $targetContainer = $('.action-more-container .dropdown .dropdown-menu ul, .more-tweet-actions .dropdown .dropdown-menu ul');
  ...
  function tripadvisorQuickAdd (attempt) {
    ...
    var $wrapper = $('.couponTeaser');
    var $existingButton =  $wrapper.find('span').first();
    ...
    $button.attr('id', buttonId).removeAttr('onclick').addClass('tripadvisor');
    ...
    $button.replaceWith($('<a class="tripadvisor" id="' + buttonId + '">' + addString + '</a>'));
